...
banks_footprint( fd_topo_t const *     topo,
  ...
  return fd_banks_footprint( VAL("max_live_slots"), VAL("max_fork_width"), VAL("max_stake_accounts"), VAL("max_stake_accounts_fallback"), VAL("max_vote_accounts") );
}
...
banks_new( fd_topo_t const *     topo,
  ...
  FD_TEST( fd_banks_new( fd_topo_obj_laddr( topo, obj->id ), VAL("max_live_slots"), VAL("max_fork_width"), VAL("max_stake_accounts"), VAL("max_stake_accounts_fallback"), VAL("max_vote_accounts"), VAL("bench_max_cost_per_block"), seed ) );
}
